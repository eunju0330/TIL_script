...
//실기간 함수 허용하는 경우)보안이 필요하지 않은 가벼운 프로그래밍 부분 (예)리뷰 글자 수 제한 등 
...
function weightCal (){
    ...
    //최종결과예) 당신의 적정체중은 ?kg이며 ?kg초과되셨습니다.
    console.log(`당신의 적정체중은 ${normalWeight}kg이며 ${userWeight.value-normalWeight}kg초과되셨습니다.`);
