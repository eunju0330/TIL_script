...
//초기 설정
orderNum.value = num;
//증가 +버튼 클릭 시 수량이 1씩 증가돼서 orderNum 출력
...
//장바구니 클릭 시 '장바구니 담겼습니다' 메세지 출력
/* cartBtn.addEventListener('click',()=>{//화살표 함수
    alert('장바구니 담겼습니다');
}) */
/* cartBtn.addEventListener('click',cartFunc); //함수호출(함수반복)
function cartFunc(){
    alert('장바구니 담겼습니다');
} */
cartBtn.addEventListener('click',function(){//익명함수(this)
    alert('장바구니 담겼습니다');
})
