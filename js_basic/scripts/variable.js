...
//객체의 개수를 체크할땐 보통 0부터 숫자를 인식하지만 특정 속성이나 함수는 1부터 인식하는 종류들도 있다. 대표적인 1부터 인식하는 속성은 문자열의 길이를 체크하는 leagth 속성이다.
//hello.length; 결과-> 5
...
let num2 = 30;
//let num2 = 40;
//let 변수생성키워드는 이미 생성한 변수를 중복선언하지 못하도록 체크하기 때문애 개발자의 실수를 방지할 수 있다.
const num3 = 50;
//const num3; 중복선언불가
...
let rectangle = { //rectangle객체변수명은 콜스택 저장
...
console.log(user_info.gender, user_info);
...
console.log(`오늘은 ${yoil[2]}요일입니다`)//오늘은 ?요일입니다
console.log(`내일은 ${yoil[3]}요일입니다`)//내일은 ?요일입니다